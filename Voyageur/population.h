...
extern void mutationClones(Population *population, int type);

/*** Les meilleurs et les clones sont comparares                     ***/
/*** Chaque couple (meilleur,clone) est evalue...                    ***/
/*** Et on garde le meilleur des deux                                ***/
extern void selectionMeilleursEtClonesMutes(Population *population, int type);

/*** Les moins bons doivent etre a gauche (apres un tri par exemple) ***/
extern void mutationMoinsBons(Population *population, int type);
